...
3. **Craft the Dialogue:**
   Develop a natural, conversational flow between the host (Ujjwal) and the guest speaker (the author or an expert on the topic). Incorporate:
   ...
   - The host (Ujjwal) always initiates the conversation and interviews the guest
...
LENGTH_MODIFIER = "Keep the podcast brief, around 1-2 minutes long."
