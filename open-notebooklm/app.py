...
import os
os.environ["FFMPEG_BINARY"] = "C:\\ffmpeg\\ffmpeg.exe"
os.environ["FFPROBE_BINARY"] = "C:\\ffmpeg\\ffprobe.exe"
os.environ["FFPLAY_BINARY"] = "C:\\ffmpeg\\ffplay.exe"
...
def generate_podcast(
    ...
    if length == "Short (1-2 min)":
        ...
        # llm_output = generate_script(modified_system_prompt, text, MediumDialogue) # FIME: UNCOMMENT
        llm_output = generate_script(modified_system_prompt, text, ShortDialogue)
