...
<table style="border-collapse: collapse; border: none; padding: 20px;">
  <tr style="border: none;">
    <td style="border: none; vertical-align: top; padding-right: 30px; padding-left: 30px;">
      <img src="https://mindgrasp.ai/_next/image?url=%2Fimages%2Ffice-space-w-min.png&w=750&q=75" alt="Open NotebookLM" width="120" style="margin-bottom: 10px;">
    </td>
